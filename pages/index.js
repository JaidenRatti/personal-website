  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.header}>
        ...
        <p className={styles.description}>2nd year computer science student at the University of Waterloo; pursuing a double specialization in hci & business + a minor in English.</p>
